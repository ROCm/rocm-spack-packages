...
class LlvmAmdgpu(CMakePackage, LlvmDetection, CompilerPackage):
    ...
    license("Apache-2.0")
    version("develop", branch="amd-staging", commit="43215c73116c407735c85a180d174f718798c328")
    ...
    resource(
        ...
        branch="develop",
        commit="ca4b97ef2cc606883313c196cdb5a31c7095b6c1",
        when="@develop",
    )
    ...
    resource(
        ...
        branch="main",
        commit="aa7c842d4ec5b7015022ae6c6b91a4365bb6b91d",
        when="@develop",
    )
