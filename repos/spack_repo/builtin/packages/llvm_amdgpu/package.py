...
class LlvmAmdgpu(CMakePackage, LlvmDetection, CompilerPackage):
    ...
    license("Apache-2.0")
    version("develop", branch="amd-staging", commit="926d90666f4263a21ce691701a6fd3858fc32372")
    ...
    resource(
        ...
        branch="develop",
        commit="ccd356f07e7972dacd0fe5a6355ca4f9e53c833d",
        when="@develop",
    )
    ...
    resource(
        ...
        branch="main",
        commit="d575617fd44ef55eb6c8857383e82c2ed4f89ff2",
        when="@develop",
    )
